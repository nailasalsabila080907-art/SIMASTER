    ...
    <style>
        ...
        * {
        ...
        @media (max-width:991.98px) {
            ...
            .form-logo-mobile .logo-badge img {
                width: 100%;
                height: 100%;
                object-fit: contain
            }

            .form-logo-mobile .logo-badge span {
                color: var(--bs-primary);
                font-weight: 800;
                font-size: .85rem
            }

            .form-logo-mobile .school-name {
                font-size: .78rem;
                letter-spacing: .1em;
                text-transform: uppercase;
                color: var(--ink-muted)
        ...
        .input-field:focus {
            ...
            box-shadow: 0 0 0 3px rgba(23, 135, 84, .12);
            background: #fff;
        }
            ...
            <div class="form-inner">
                ...
                @if ($errors->any())
                    <div class="alert d-flex align-items-start gap-2 border-0 mb-4"
                        style="background:#FCEBEA;color:#C4463F;border-radius:12px;font-size:.83rem;">
                ...
                <form method="POST" action="{{ route('login.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="username" name="username" value="{{ old('username') }}" required
                            autofocus autocomplete="username" class="input-field form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="password" name="password" required autocomplete="current-password"
                            class="input-field form-control" placeholder="••••••••">
                    </div>
