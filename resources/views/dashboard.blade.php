...
<div class="d-flex flex-wrap align-items-end justify-content-between gap-3 mb-4">
    <div>
        ...
        <h2 class="mb-1" style="font-size:1.5rem">
            {{ $user->pegawai->nama_lengkap ?? $user->username }}
        </h2>
    ...
    @if($approvalSaya > 0)
        <a href="{{ route('approval.index') }}"
           ...
           ">
            ...
            {{ $approvalSaya }} approval menunggu
        </a>
    @endif
</div>
        ...
        <div class="col-6 col-md-4 col-xl">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span
                            ...
                            style="
                                width:42px;
                                height:42px;
                                background:{{ $statGradients[$i % count($statGradients)] }};
                                font-size:1.1rem;
                            ">
                            {{ $item['icon'] }}
                        </span>
                    ...
                    <p
                        class="mb-0 fw-bold"
                        style="font-size:1.65rem;color:var(--ink);">
                        {{ $item['nilai'] }}
                    </p>
                ...
                <div class="d-flex flex-wrap align-items-start justify-content-between gap-3">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option
                                value="bulan"
                                {{ ($modeGrafik ?? 'bulan') === 'bulan' ? 'selected' : '' }}>
                                Per Bulan
                            </option>

                            <option
                                value="minggu"
                                {{ ($modeGrafik ?? '') === 'minggu' ? 'selected' : '' }}>
                                Per Minggu
                            </option>
                        ...
                        <input
                            type="date"
                            name="tanggal_mulai"
                            value="{{ $tanggalMulai ?? now()->startOfYear()->format('Y-m-d') }}"
                        ...
                        <input
                            type="date"
                            name="tanggal_akhir"
                            value="{{ $tanggalAkhir ?? now()->format('Y-m-d') }}"
                            class="form-control form-control-sm"
                            style="
                                width:140px;
                                border-radius:9px;
            ...
            <div class="card-header d-flex align-items-start justify-content-between">
                ...
                <div>
                    ...
                    <p
                        class="text-muted mb-0"
                        style="font-size:.78rem;">
                        {{ $notifikasiBelumDibaca }} belum dibaca
                    </p>
            ...
            <div
                ...
                <div class="list-group list-group-flush">
                    ...
                    @forelse($notifikasiTerbaru as $n)
                        ...
                        <div
                            class="list-group-item d-flex gap-3 py-3 px-3 border-0 border-bottom"
                            style="min-width:0;">

                            <a
                                href="{{ route('notifikasi.tandai-dibaca',$n) }}"
                                onclick="
                                    event.preventDefault();
                                    document.getElementById('notif-{{ $n->id_notifikasi }}').submit();
                                "
                                class="d-flex gap-3 text-decoration-none flex-grow-1"
                                style="min-width:0;">
                                ...
                                <span
                                    ...
                                    style="
                                        width:34px;
                                        height:34px;
                                        background:{{ $n->sudah_dibaca ? '#F1F2F4' : '#FDF1E2' }};
                                        color:#F7A02A;
                                        font-size:.6rem;
                                    ">
                                ...
                                <span
                                    ...
                                    <span
                                        class="d-block fw-semibold text-truncate"
                                        style="
                                            font-size:.85rem;
                                            color:var(--ink);
                                        ">
                                    ...
                                    <span
                                        class="d-block text-muted notif-pesan"
                                    ...
                                    @if(strlen($n->pesan) > 60)
                                        ...
                                        <a
                                            ...
                                            onclick="
                                                ...
                                                this.textContent =
                                                    p.classList.contains('notif-expanded')
                                                    ? 'Sembunyikan'
                                                    : 'Lihat selengkapnya';
                                            ">
                        ...
                        <form
                            id="notif-{{ $n->id_notifikasi }}"
                            method="POST"
                            action="{{ route('notifikasi.tandai-dibaca',$n) }}"
                            class="d-none">
                    ...
                    @empty
                        ...
                        <div
                            ...
                            <i
                                class="bi bi-bell-slash fs-3 d-block mb-2">
                            </i>
                    ...
                    <tbody>
                        ...
                        @forelse($aktivitasTerbaru as $log)
                            ...
                            <tr>
                                ...
                                <td
                                    class="ps-3 text-muted text-nowrap"
                                    style="font-size:.78rem;">
        ...
        <div class="card h-100">
            <div class="card-header">
                ...
                <p
                    class="text-muted mb-0"
                    style="font-size:.78rem;">
                    Jumlah surat keluar berdasarkan kategori
                </p>
            ...
            <div class="card-body">
                ...
                @php
                    $maxKategori = max(
                        1,
                        $ringkasanKategori->max('jumlah') ?? 0
                    );
                @endphp
                    ...
                    <div class="mb-3">
                        ...
                        <div
                            ...
                            <div
                                ...
                                role="progressbar"
                                style="
                                    width:{{ ($r['jumlah'] / $maxKategori) * 100 }}%;
                                    background:#178754;
                                    border-radius:99px;
                                ">
                            </div>
...
<script>
    ...
    const canvas = document.getElementById('chartAktivitasSurat');
